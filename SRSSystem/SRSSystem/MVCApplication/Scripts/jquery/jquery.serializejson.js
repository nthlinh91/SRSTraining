/*!
  ...
  modified  2015/10/21 kmasuda/SRS: default, no deep copy. use deep copy, please use option { deepCopy: true }
...
(function ($) {
        ...
        $.each(formAsArray, function (i, input) {
            ...
            if (type !== 'skip') { // easy way to skip a value
                ...
                if (opts.deepCopy) {
                    ...
                    // set when only not value setted
                    if (serializedObject[input.name] === undefined) {
                        serializedObject[input.name] = value;
                    }
                }
            }
        });
    ...
    $.serializeJSON = {
        ...
        //
        deepSet: function (o, keys, value, opts, orgKey) {
